...
<section class="content">
	<div class="box box-widget">
		<div class="box-header with-border">
			<h6 class="box-title">Master supplier</h6>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="row">
					<div class="col-md-6">
						<label class="small-label">Nama supplier</label>
...
var tabel = $("#dataGrid").DataTable({
		...
		paging: true,
		"ajax": {
			url: "controller/master_supplier.php",
			type: "post",
			data: {
				act: "getAll",
			}
	...
	function edit(id){
		...
		$.post("controller/master_supplier.php",{
			act: "getData",
			id: id
		}, function(data){
			var dataSet = data.result[0];

			$("#txtId").val(dataSet.id_supplier);
