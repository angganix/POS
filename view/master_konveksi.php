<section class="content-header">
	<h1>
		Master Konveksi
		<small>Daftar Konveksi</small>
	</h1>
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-th"></i> Dashboard</a></li>
		<li class="active">Master Konveksi</li>
	</ol>
</section>
...
<section class="content">
	<div class="box box-widget">
		<div class="box-header with-border">
			<h6 class="box-title">Master Konveksi</h6>
		...
		<div class="box-body">
			<div class="table-responsive">
				<table class="table table-responsive table-bordered table-hover" id="dataGrid">
					<thead>
						<tr>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="row">
					<div class="col-md-6">
						<label class="small-label">Nama Konveksi</label>
...
<script type="text/javascript">
	...
	var tabel = $("#dataGrid").DataTable({
		...
		paging: true,
		"ajax": {
			url: "controller/master_konveksi.php",
			type: "post",
			data: {
				act: "getAll",
			}
	...
	function edit(id){
		...
		$.post("controller/master_konveksi.php",{
			act: "getData",
			id: id
		}, function(data){
			var dataSet = data.result[0];

			$("#txtId").val(dataSet.id_konveksi);
